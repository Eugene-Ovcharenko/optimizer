...
def _read_csv_data() -> list:
    data = []
    with open(os.path.join(get_global_path(), 'configuration', get_material_csv_path()), newline='') as csvfile:
        reader = csv.reader(csvfile)
        # пропускаем строку с заголовком (и/или комментариями)
        header = next(reader)
        for row in reader:
            # если строка комментарий или пустая — пропускаем
...
def write_inp_contact(
    ...
    See Also:
        ...
        - `run_abaqus`, `get_history_output`: For execution and postprocessing.
    """
    fileID = open(fileName, 'w')
    ElementType = 'S3'
    fileID.write('*Heading\n')
    ...
    fileID.write('*Amplitude, name=Amp-Aortic\n')
    fileID.write(
        '    0.000000,        0.011114,        0.227544,        0.009892,        0.232141,        0.010503,        0.234439,        0.011236\n')
    fileID.write(
        '    0.239036,        0.012091,        0.250528,        0.013434,        0.262020,        0.014533,        0.282706,        0.015632\n')
    fileID.write(
        '    0.303392,        0.015865,        0.319481,        0.015999,        0.351659,        0.015865,        0.374643,        0.015754\n')
    fileID.write(
        '    0.399926,        0.015144,        0.420612,        0.014777,        0.441298,        0.014900,        0.468879,        0.014777\n')
    fileID.write(
        '    0.519444,        0.014265,        0.574606,        0.013800,        0.857313,        0.011114,        1.084857,        0.009892\n')
    fileID.write(
        '    1.089454,        0.010503,        1.091752,        0.011236,        1.096349,        0.012091,        1.107841,        0.013434\n')
    fileID.write(
        '    1.119333,        0.014533,        1.140019,        0.015632,        1.160705,        0.015865,        1.176794,        0.015999\n')
    fileID.write(
        '    1.208972,        0.015865,        1.231956,        0.015754,        1.257239,        0.015144,        1.277924,        0.014777\n')
    fileID.write(
        '    1.298610,        0.014900,        1.326191,        0.014777,        1.376757,        0.014265,        1.431919,        0.013800\n')
    fileID.write('    1.714625,        0.011114\n')

    fileID.write('*Amplitude, name=Amp-Ventricular\n')
    fileID.write(
        '    0.000000,        0.002933,        0.020350,        0.002933,        0.031656,        0.003000,        0.049746,        0.003066\n')
    fileID.write(
        '    0.065574,        0.003297,        0.079141,        0.003297,        0.094969,        0.003420,        0.108536,        0.003664\n')
    fileID.write(
        '    0.119842,        0.004152,        0.128886,        0.004519,        0.142453,        0.005007,        0.151498,        0.005129\n')
    fileID.write(
        '    0.158282,        0.005129,        0.167326,        0.004763,        0.174110,        0.004274,        0.187677,        0.003542\n')
    fileID.write(
        '    0.212550,        0.009282,        0.232900,        0.013732,        0.248728,        0.014799,        0.269079,        0.015599\n')
    fileID.write(
        '    0.293952,        0.016132,        0.321086,        0.016265,        0.341436,        0.016132,        0.352742,        0.015999\n')
    fileID.write(
        '    0.373092,        0.015732,        0.397965,        0.014777,        0.416055,        0.013312,        0.490673,        0.004274\n')
    fileID.write(
        '    0.511024,        0.003175,        0.535896,        0.002443,        0.583381,        0.002687,        0.639910,        0.002933\n')
    fileID.write(
        '    0.856982,        0.002933,        0.877332,        0.002933,        0.888638,        0.003000,        0.906728,        0.003066\n')
    fileID.write(
        '    0.922556,        0.003297,        0.936123,        0.003297,        0.951951,        0.003420,        0.965518,        0.003664\n')
    fileID.write(
        '    0.976824,        0.004152,        0.985868,        0.004519,        0.999435,        0.005007,        1.008480,        0.005129\n')
    fileID.write(
        '    1.015264,        0.005129,        1.024308,        0.004763,        1.031092,        0.004274,        1.044659,        0.003542\n')
    fileID.write(
        '    1.069532,        0.009282,        1.089882,        0.013732,        1.105710,        0.014799,        1.126061,        0.015599\n')
    fileID.write(
        '    1.150933,        0.016132,        1.178067,        0.016265,        1.198418,        0.016132,        1.209724,        0.015999\n')
    fileID.write(
        '    1.230074,        0.015732,        1.254947,        0.014777,        1.273036,        0.013312,        1.347655,        0.004274\n')
    fileID.write(
        '    1.368005,        0.003175,        1.392878,        0.002443,        1.440363,        0.002687,        1.496892,        0.002933\n')
    fileID.write('    1.713964,        0.002933\n')

    fileID.write('*Amplitude, name=Amp-Atrium\n')
    fileID.write(
        '    0.0000000,       0.0034664,       0.0316563,       0.0034664,       0.0542680,       0.0034664,       0.0881855,       0.0037330\n')
    fileID.write(
        '    0.1334088,       0.0043966,       0.1492370,       0.0048851,       0.1628040,       0.0047630,       0.1808933,       0.0039081\n')
    fileID.write(
        '    0.1899379,       0.0035417,       0.2215943,       0.0037859,       0.2464671,       0.0034196,       0.2577729,       0.0029311\n')
    fileID.write(
        '    0.4974565,       0.0046408,       0.5268517,       0.0030532,       0.5472022,       0.0029311,       0.5901643,       0.0032974\n')
    fileID.write(
        '    0.8411537,       0.0034664,       0.8569819,       0.0034664,       0.8886382,       0.0034664,       0.9112499,       0.0034664\n')
    fileID.write(
        '    0.9451674,       0.0037330,       0.9903907,       0.0043966,       1.0062189,       0.0048851,       1.0197859,       0.0047630\n')
    fileID.write(
        '    1.0378752,       0.0039081,       1.0469199,       0.0035417,       1.0785762,       0.0037859,       1.1034490,       0.0034196\n')
    fileID.write(
